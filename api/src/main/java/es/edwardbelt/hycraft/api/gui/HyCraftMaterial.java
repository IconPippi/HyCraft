...
public enum HyCraftMaterial {
    ...
    private static final Map<String, HyCraftMaterial> ID_MAP = new HashMap<>();

    static {
        for (HyCraftMaterial material : values()) {
            ID_MAP.put(material.id, material);
        }
    }

    private final String id;

    public static HyCraftMaterial fromId(String id) {
